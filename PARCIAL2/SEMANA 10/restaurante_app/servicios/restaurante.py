...
class Restaurante:
    ...
    Mantiene la lógica de negocio (registro, búsqueda, actualización y eliminación)
    y provee métodos auxiliares para exportar/recuperar productos en formato dict.
    """
    ...
    def cargar_productos(self, productos: List[Producto]) -> None:
        ...
        No sobrescribe la colección existente, intenta registrar cada producto y
        omite duplicados.
        """
        for p in productos:
            try:
                ...
                # No detener la carga por un producto inválido
                continue
